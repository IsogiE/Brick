...
- Brick uses Discord OAuth user tokens for login and must not embed a bot token or Discord client secret. Cached Discord sessions are stored under the user's Brick config directory.
