...
- Download-cache cleanup is restricted to the system temporary `Brick/updates` folder. Never extend it into a WoW `Interface` folder or its contents. Normal installation of the three managed ART addons is separate from download-cache cleanup.
