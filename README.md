...
Brick keeps an encrypted raid-review cache on your device so known pulls remain available when switching streams or restarting. It refreshes in the background, updates existing reports instead of duplicating them, and retains up to three weeks of data within a 2 MiB limit per guild and account.
